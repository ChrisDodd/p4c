...
class DeclarationLookup {
 public:
    virtual IR::Ptr<IR::IDeclaration>
...
class ReferenceMap final : public ProgramMap, public NameGenerator, public DeclarationLookup {
 ...
 public:
    ...
    IR::Ptr<IR::IDeclaration> getDeclaration(const IR::Path *path, bool notNull = false)
        const override;
    ...
    IR::Ptr<IR::IDeclaration> getDeclaration(const IR::This *pointer, bool notNull = false)
        const override;
