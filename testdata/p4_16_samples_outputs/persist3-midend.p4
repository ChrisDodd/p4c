...
control c(inout headers_t hdr, inout metadata_t meta) {
    ...
    @hidden table tbl_persist3l57_16 {
        ...
        const default_action = persist3l57_32();
    }
    @hidden table tbl_persist3l57_17 {
        actions = {
            persist3l57_16();
        }
        const default_action = persist3l57_16();
    }
    @hidden table tbl_persist3l57_18 {
        actions = {
            persist3l57_17();
        }
        const default_action = persist3l57_17();
    }
    @hidden table tbl_persist3l57_19 {
        actions = {
            persist3l57_18();
        }
        const default_action = persist3l57_18();
    }
    @hidden table tbl_persist3l57_20 {
        actions = {
            persist3l57_19();
        }
        const default_action = persist3l57_19();
    }
    @hidden table tbl_persist3l57_21 {
        actions = {
            persist3l57_20();
        }
        const default_action = persist3l57_20();
    }
    @hidden table tbl_persist3l57_22 {
        actions = {
            persist3l57_21();
        }
        const default_action = persist3l57_21();
    }
    @hidden table tbl_persist3l57_23 {
        actions = {
            persist3l57_22();
        }
        const default_action = persist3l57_22();
    }
    @hidden table tbl_persist3l57_24 {
        actions = {
            persist3l57_23();
        }
        const default_action = persist3l57_23();
    }
    @hidden table tbl_persist3l57_25 {
        actions = {
            persist3l57_24();
        }
        const default_action = persist3l57_24();
    }
    @hidden table tbl_persist3l57_26 {
        actions = {
            persist3l57_25();
        }
        const default_action = persist3l57_25();
    }
    @hidden table tbl_persist3l57_27 {
        actions = {
            persist3l57_26();
        }
        const default_action = persist3l57_26();
    }
    @hidden table tbl_persist3l57_28 {
        actions = {
            persist3l57_27();
        }
        const default_action = persist3l57_27();
    }
    @hidden table tbl_persist3l57_29 {
        actions = {
            persist3l57_28();
        }
        const default_action = persist3l57_28();
    }
    @hidden table tbl_persist3l57_30 {
        actions = {
            persist3l57_29();
        }
        const default_action = persist3l57_29();
    }
    @hidden table tbl_persist3l57_31 {
        actions = {
            persist3l57_30();
        }
        const default_action = persist3l57_30();
    }
    @hidden table tbl_persist3l57_32 {
        actions = {
            persist3l57_31();
        }
        const default_action = persist3l57_31();
    }
    ...
    apply {
        if (hdr.h1.h1 > hdr.h1.h2) {
            ...
            if (hsiVar_0 == 4w0) {
                tbl_persist3l57_17.apply();
            } else if (hsiVar_0 == 4w1) {
                tbl_persist3l57_18.apply();
            } else if (hsiVar_0 == 4w2) {
                tbl_persist3l57_19.apply();
            } else if (hsiVar_0 == 4w3) {
                tbl_persist3l57_20.apply();
            } else if (hsiVar_0 == 4w4) {
                tbl_persist3l57_21.apply();
            } else if (hsiVar_0 == 4w5) {
                tbl_persist3l57_22.apply();
            } else if (hsiVar_0 == 4w6) {
                tbl_persist3l57_23.apply();
            } else if (hsiVar_0 == 4w7) {
                tbl_persist3l57_24.apply();
            } else if (hsiVar_0 == 4w8) {
                tbl_persist3l57_25.apply();
            } else if (hsiVar_0 == 4w9) {
                tbl_persist3l57_26.apply();
            } else if (hsiVar_0 == 4w10) {
                tbl_persist3l57_27.apply();
            } else if (hsiVar_0 == 4w11) {
                tbl_persist3l57_28.apply();
            } else if (hsiVar_0 == 4w12) {
                tbl_persist3l57_29.apply();
            } else if (hsiVar_0 == 4w13) {
                tbl_persist3l57_30.apply();
            } else if (hsiVar_0 == 4w14) {
                tbl_persist3l57_31.apply();
            } else if (hsiVar_0 == 4w15) {
                tbl_persist3l57_32.apply();
            }
